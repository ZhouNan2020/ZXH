...
with tab1:
        Breastfeeding = st.text_input('母乳亲喂（单位:分钟）', value='',on_change=None)
        BreastBottleFeeding = st.text_input('母乳瓶喂（单位:ml）', value='',on_change=None)
        FormulaMilkPowder = st.text_input('配方奶粉（单位:ml）', value='',on_change=None)
